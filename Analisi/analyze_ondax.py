"""
Script that plots the properties of the spectra observed with the Ondax laser.
...
fig = plt.figure()
ax = fig.add_subplot()
plot = ax.scatter(all_currents, all_temperatures, c =all_widths, marker = "o")
ax.set_xlabel("Corrente [mA]")
ax.set_ylabel("Temperatura [°C]")
cbar = fig.colorbar(plot, ax = ax)
cbar.ax.set_ylabel('Larghezza del picco (Std. Dev.) [nm]', rotation=270, labelpad=20)
fig.savefig("linewidthOndax.pdf", bbox_inches = "tight")

fig2 = plt.figure()
ax2 = fig2.add_subplot()
plot2 = ax2.scatter(all_currents, all_temperatures, c =all_means, marker = "o")
...
fig2.savefig("meanOndax.pdf", bbox_inches = "tight")

fig3 = plt.figure()
ax3 = fig3.add_subplot()
plot3 = ax3.scatter(all_currents, all_temperatures, c =all_areas, marker = "o")
...
fig3.savefig("areaOndax.pdf", bbox_inches = "tight")
