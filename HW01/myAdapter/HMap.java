...
public interface HMap {
     ...
     * operation may be used to distinguish these two cases. More formally, if this
     * map contains a mapping from a key k to a value v such that (key==null ?
     * k==null : key.equals(k)), then this method returns v; otherwise it returns
     ...
     * @see Map.Entry.hashCode(), Object.hashCode(), Object.equals(Object),
     *      equals(Object)
     */
    @Override
    int hashCode();
    ...
    public interface HEntry {
         ...
         *                                       backing map.
         * @throws IllegalArgumentException      - if some aspect of this value prevents
         *                                       it from being stored in the backing
         *                                       map.
